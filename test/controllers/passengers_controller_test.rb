...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { age: @passenger.age, flight_id: @passenger.flight_id, name: @passenger.name, passport_id: @passenger.passport_id }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { age: @passenger.age, flight_id: @passenger.flight_id, name: @passenger.name, passport_id: @passenger.passport_id }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
